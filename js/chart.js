...
function data() { 
    // This function collects the input and stores in an array
...
function barChart() {    
    // This function draws a bar chart on the canvas   
    var canvas = document.getElementById('myCanvas');
    var ctx = canvas.getContext('2d');     
    var total = 0;
    var min = myData[0];
    ...
    // This block of code clears the canvas and draws a white rectangle in the canvas
    ctx.clearRect(0,0,canvas.width,canvas.height);
    ctx.beginPath(); 
    ctx.fillStyle = 'white'; 
    ctx.fillRect(0, 0, canvas.width, canvas.height);        
...
function lineChart(){  
    // This function draws a line graph on the canvas      
    var canvas = document.getElementById('myCanvas');
    var ctx = canvas.getContext('2d');    
    var max = myData[0]
    var y,y2,x2;
